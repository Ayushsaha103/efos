...
def calc_ECI_to_ECEF_func(JD_i, seconds_per_day, days_per_Julian_century, JD_epoch):
...
# FUNCTION CALL
calc_ECI_to_ECEF_func(JD_i, seconds_per_day, days_per_Julian_century, JD_epoch)
