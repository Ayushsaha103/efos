...
def func_mop_moon_pos(wb, coeff, fract_v, mop_moon_jd_lookup, JD_tt):
...
#------------------------------------------------------------------------------------------------------
# VARIABLE DEFINITIONS (Driver Code)
#------------------------------------------------------------------------------------------------------
...
# FUNCTION CALL
func_mop_moon_pos(wb, coeff, fract_v, mop_moon_jd_lookup, JD_tt)
