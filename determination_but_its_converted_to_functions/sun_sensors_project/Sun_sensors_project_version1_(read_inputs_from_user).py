...
# I got this program's accuracy as high as I could. It seems to be about 80-95% or something.
...
################################## THE BIG COMPUTING FUNCTION ##################################

def func_get_sun_position(input_floats):
...
# FUNCTION CALL
func_get_sun_position(input_floats)
